...
jQuery(document).ready(function(){
	...
	if (jQuery(window).height() < '1000') {
			jQuery(".home-title").css('padding-bottom','100px');
			jQuery(".home-title").css('margin-top','0px');
		}
	
	if (jQuery(window).height() < '900') {
			jQuery(".home-title").css('padding-bottom','55px');
			jQuery(".home-title").css('margin-top','0px');
		}
		...
		if (jQuery(window).height() < '820') {
			jQuery(".home-title").css('padding-bottom','30px');
		...
		if (jQuery(window).height() < '720') {
			...
			jQuery(".energybar img").css('margin-top','-80px');
		}
...
if(jQuery(window).width() <= 735) {
				...
				jQuery("#nav").css("left","240px");
				
				jQuery(".toplinks").css("position","absolute");
				jQuery(".toplinks").css("left","429px");
				...
				jQuery("#hpnext").css("left","7px");
					...
					jQuery("#nav").css("right","auto");
					
					jQuery(".toplinks").css("position","relative");
					jQuery(".toplinks").css("right","auto");
...
if(jQuery(window).width() <= 1153) {
	...
	jQuery(window).resize(function() {
		...
		if(jQuery(window).width() <= 1153) {
					...
					jQuery("#nav").css("position","absolute");
						...
						jQuery("#nav").css("left","auto")
						
						jQuery(".toplinks").css("position","absolute");
						jQuery(".toplinks").css("right","0px");
						jQuery(".toplinks").css("left","auto")
					}
					jQuery("body").css("width","1153px");
  ...
  jQuery('#teaser-2 .circle1 .inner').mouseover(function(){
			jQuery('#teaser-2 .circle1').removeClass('transp').addClass('hover');
		}).mouseout(function(){
			jQuery('#teaser-2 .circle1').removeClass('hover').addClass('transp');		
		});
		jQuery('#teaser-2 .circle2 .inner').mouseover(function(){
			jQuery('#teaser-2 .circle2').removeClass('transp').addClass('hover');
		}).mouseout(function(){
			jQuery('#teaser-2 .circle2').removeClass('hover').addClass('transp');		
		});
		jQuery('#teaser-2 .circle3 .inner').mouseover(function(){
			jQuery('#teaser-2 .circle3').removeClass('transp').addClass('hover');
		}).mouseout(function(){
			jQuery('#teaser-2 .circle3').removeClass('hover').addClass('transp');		
		});
