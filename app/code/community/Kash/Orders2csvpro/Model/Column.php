...
* */
class Kash_Orders2csvpro_Model_Column extends Mage_Core_Model_Abstract
{
	 ...
	 *
	 * @param Kash_Orders2csvpro_Model_File $file
	 * @return Kash_Orders2csvpro_Model_Mysql4_Column_Collection
	 */
	public function getColumnByFile(Kash_Orders2csvpro_Model_File $file)
	{
